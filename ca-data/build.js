  ...
  function build (refUrl, callback) {
    ...
    got.get(refUrl, function (err, body) {
      ...
      eachAsync(solutionArr, function (item, index, done) {
        ...
        fs.writeFile('rule' + ruleNumber + 'solution.json', trailingLine(JSON.stringify(ruleSetsArr)))
        done()
      }, function () {
